...
<div class="single-image">
  <div class="gallery__item is-1-1"
       data-src="{{ '/assets/images/satak_1.webp' | relative_url }}"
       data-sub-html="Copyright: Law Yao Hua">
    <img src="{{ '/assets/images/satak_1.webp' | relative_url }}"
         alt="The one-hour drive between Kuala Lipis and Raub takes one pass more than a dozen forest reserves" />
    <p class="gallery__caption">Copyright: Law Yao Hua</p>
  </div>
</div>
...
<div class="single-image">
  <div class="gallery__item is-1-1"
       data-src="{{ '/assets/images/satak_2.webp' | relative_url }}"
       data-sub-html="Copyright: Law Yao Hua">
    <img src="{{ '/assets/images/satak_2.webp' | relative_url }}"
         alt="Satellite image analyses show that all forest reserves between Kuala Lipis and Raub have been logged since 2001, except for Satak." />
    <p class="gallery__caption">Copyright: Law Yao Hua</p>
  </div>
</div>
...
<div class="single-image">
  <div class="gallery__item is-1-1"
       data-src="{{ '/assets/images/satak_2018-2026.gif' | relative_url }}"
       data-sub-html="Copyright: Law Yao Hua">
    <img src="{{ '/assets/images/satak_2018-2026.gif' | relative_url }}"
         alt="Satellite images of Satak forest reserve from 2018 to 2026 showing no tree loss" />
    <p class="gallery__caption">Copyright: Law Yao Hua</p>
  </div>
</div>
...
<div class="single-image">
  <div class="gallery__item is-16-9"
       data-src="{{ '/assets/images/satak_3.webp' | relative_url }}"
       data-sub-html="">
    <img src="{{ '/assets/images/satak_3.webp' | relative_url }}"
         alt="A screenshot of Gazette #655 showing the Pahang government’s degazettement of 908 ha of Satak Forest Reserve on 30 April 2026" />
...
Tree farms, or ‘forest plantations’ as the Malaysian government calls them, are plantations of fast-growing trees to be harvested for pulp or wood. Most, if not all, tree farms in Peninsular Malaysia are [operating inside forest reserves](https://www.macaranga.org/fixing-forest-plantations-part-1-take-a-break/). The developers clear the reserves and [replant with neat rows of a single tree species](https://www.macaranga.org/fixing-forest-plantations-part-2-faster-replanting-needed/). My experience reporting on tree farms suggests that many planters would love to have Satak. But they could do so without degazetting Satak. So, I don’t think a tree farm is in the works here.

### Oil palm? It couldn’t sell

MSPO, Malaysia’s mandatory certification for its oil palm industry, [prohibits clearing natural forests since January 2021](https://mspo.org.my/how-sustainable-palm-oil-and-mspo-certification-support-global-environmental-goals/). While the Malaysian Palm Oil Board cannot stop anybody from planting oil palm on deforested land, it can prohibit the trade of oil palm from that site. It would really be a stretch of (horrible) imagination to have a state government degazette forest reserve to plant oil palm in 2026. VERY unlikely.
